...
<%
	String mQuery = "update entrevista_social set " + 
					"pre_soc_qiii = ? , " +
					"pre_soc_qiv1 = ? , " +
					"pre_soc_qiv2 = ? , " +
					"pre_soc_qv11 = ? , " +
	...
	try{
		if (session.getAttribute("email") != null) {
			...
			prest.setString(25,request.getParameter("pre_fecha_entrevista_social"));  
			prest.setString(26,request.getParameter("pre_direccion_pais_de_origen"));
			prest.setString(27,request.getParameter("pre_ocup_pais_de_origen"));
			prest.setString(28,request.getParameter("pre_lugar_de_trabajo"));
