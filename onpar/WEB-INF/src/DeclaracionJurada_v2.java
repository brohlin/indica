...
public class DeclaracionJurada_v2 extends HttpServlet
{
	...
	{	
		...
		try
		{
			...
			doc.add(new Phrase("Ud. tiene nacionalidad, residencia, u otro estatus migratorio en otro país? "));
			...
			doc.add(Chunk.NEWLINE);	
			doc.add(Chunk.NEWLINE);
			doc.add(new Paragraph("IV. Indique cualquier tipo de servicio militar", FontFactory.getFont(FontFactory.HELVETICA, 12, Font.BOLD, new java.awt.Color(0, 0, 0))));
			...
			doc.add(Chunk.NEWLINE);	
			doc.add(Chunk.NEWLINE);
			doc.add(new Paragraph("V. Indique su afiliación, o inscrito en, cualquier tipo de organización", FontFactory.getFont(FontFactory.HELVETICA, 12, Font.BOLD, new java.awt.Color(0, 0, 0))));
			...
			doc.add(Chunk.NEWLINE);	
			doc.add(Chunk.NEWLINE);
			doc.add(new Paragraph("VI. Ud. ha sido arrestado o detenido alguna vez", FontFactory.getFont(FontFactory.HELVETICA, 12, Font.BOLD, new java.awt.Color(0, 0, 0))));
