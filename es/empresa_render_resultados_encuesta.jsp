...
<%
	...
	if ( un == null || un.equals("null")) {
		...
		response.sendRedirect("/indica/es/main.jsp?target=login&page=empresa_render_resultados_encuesta&organization_id=" + p_organization_id);
...
<header>
	<div class="well">
		<h1 class="text-center text-white"><fmt:message key="empresa_render_resultados_encuesta.element1" /></h1>
	</div>
	<div class="well-2 bc-purple">
		<h3 class="text-center text-white"> <fmt:message key="empresa_render_resultados_encuesta.element2" /> <%= session.getAttribute("temp_admin_organization_nm").toString() %></h3>
	</div>
</header>
<!-- Cabezote gris -->
<div id="cabezote-resultados" class="bc-gray padding-medium">
	<div class="container">
		<div class="col-md-6">
			...
			%>
					<li><fmt:message key="empresa_render_resultados_encuesta.element3" /></li>
			<%
			...
			%>						
					<fmt:message key="empresa_render_resultados_encuesta.element4" /> <%= session.getAttribute("temp_admin_organization_last_mod_tmstmp").toString() %>
			<%
				}
...
<h4 class="text-center separador-top separador-bottom"><fmt:message key="empresa_render_resultados_encuesta.element10" /> </h4>

<div id="otros-comunicacion-interna">
	<h5>
		<div class="label label-primary padding-small"><fmt:message key="empresa_render_resultados_encuesta.element11" /></div>
	</h5>

	<div class="col-xs-12 text-center">
		<!-- Nav tabs -->
		<div class="blockD">
			<h4 class="text-center"><fmt:message key="empresa_render_resultados_encuesta.element12" /></h4>
			...
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane active" id="otros1">
					<div class="col-xs-12  panel-heading" >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element13" />
						</p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q1_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q1_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q1_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span>
						</h4>
					</div>
				</div>

				<div role="tabpanel" class="tab-pane active" id="otros2">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element17" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q2_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q2_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q2_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span>
						</h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros3">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element18" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q3_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q3_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q3_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span>
						</h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros4">
					<div class="col-xs-12 panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element19" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q43_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q43_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q43_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
	...
	<div class="col-xs-12 separador-bottom"  >
		<h4 class="text-center"><fmt:message key="empresa_render_resultados_encuesta.element20" /></h4>
		<div id="gr-otros-1" class="col-md-8 col-centered"></div>
	</div>
</div> <!-- fin otros-comunicacion-interna -->
<div id="otros-comunicacion-externa">
	<h5>
		<div class="label label-primary padding-small"><fmt:message key="empresa_render_resultados_encuesta.element21" /></div>
	</h5>

	<div class="col-xs-12 text-center">
		<!-- Nav tabs -->
		<div class="blockD">
			<h4 class="text-center"><fmt:message key="empresa_render_resultados_encuesta.element22" /></h4>
			<!--  ul class="nav nav-pills super-letra-indicadores centeredD" role="tablist">
		...
		<div class="marco-gris-pane centeredD col-xs-12">
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane active" id="otros5">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element23" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q4_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q4_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q4_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>

				<div role="tabpanel" class="tab-pane active" id="otros6">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element24" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q5_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q5_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q5_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros7">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element25" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q6_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q6_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q6_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros8">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element26" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q44_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q44_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q44_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
			</div> <!-- fin de tab-content -->
		</div> <!-- fin de tab panes -->
	...
	<div class="col-xs-12 separador-bottom "  >
		<h4 class="text-center"><fmt:message key="empresa_render_resultados_encuesta.element27" /></h4>
		<div id="gr-otros-2" class="col-md-8 col-centered"></div>
	</div>
</div> <!-- fin otros-comunicacion-externa -->
<div id="otros-reclutamiento">
	<h5>
		<div class="label label-primary padding-small"><fmt:message key="empresa_render_resultados_encuesta.element28" /></div>
	</h5>

	<div class="col-xs-12 text-center">
		<!-- Nav tabs -->
		<div class="blockD">
			<h4 class="text-center"><fmt:message key="empresa_render_resultados_encuesta.element29" /></h4>
			<!-- ul class="nav nav-pills super-letra-indicadores centeredD" role="tablist">
		...
		<div class="marco-gris-pane centeredD col-xs-12">
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane active" id="otros9">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element30" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q7_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q7_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q7_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>

				<div role="tabpanel" class="tab-pane active" id="otros10">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element31" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q8_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q8_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q8_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros11">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element32" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q9_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q9_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q9_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros12">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element33" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q10_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q10_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q10_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros13">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element34" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q11_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q11_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q11_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros14">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element35" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q12_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q12_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q12_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros15">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element36" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q13_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q13_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q13_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros16">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element37" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q14_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q14_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q14_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros17">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element38" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q45_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q45_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q45_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
			</div> <!-- fin de tab-content -->
		</div> <!-- fin de tab panes -->
	...
	<div class="col-xs-12 separador-bottom"  >
		<h4 class="text-center"><fmt:message key="empresa_render_resultados_encuesta.element39" /></h4>
		<div id="gr-otros-3" class="col-md-8 col-centered"></div>
	</div>
</div> <!-- fin reclutamiento -->
<div id="otros-promoción">
	<h5>
		<div class="label label-primary padding-small"><fmt:message key="empresa_render_resultados_encuesta.element40" /></div>
	</h5>

	<div class="col-xs-12 text-center">
		<!-- Nav tabs -->
		<div class="blockD">
			<h3 class="text-center"><fmt:message key="empresa_render_resultados_encuesta.element41" /></h3>
			<!-- ul class="nav nav-pills super-letra-indicadores centeredD" role="tablist">
		...
		<div class="marco-gris-pane centeredD col-xs-12">
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane active" id="otros18">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element42" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q15_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q15_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q15_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>

				<div role="tabpanel" class="tab-pane active" id="otros19">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element43" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q16_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q16_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q16_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros20">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element44" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q17_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q17_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q17_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros21">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element45" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q18_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q18_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q18_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros22">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element46" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q19_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q19_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q19_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros23">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element47" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q20_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q20_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q20_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros24">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element48" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q21_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q21_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q21_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros25">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element49" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q46_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q46_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q46_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
			</div> <!-- fin de tab-content -->
		</div> <!-- fin de tab panes -->
	...
	<div class="col-xs-12 separador-bottom"  >
		<h3 class="text-center"><fmt:message key="empresa_render_resultados_encuesta.element50" /></h3>
		<div id="gr-otros-4" class="col-md-8 col-centered"></div>
	</div>
</div> <!-- fin PROMOCION -->
<div id="otros-capacitacion">
	<h5>
		<div class="label label-primary padding-small"><fmt:message key="empresa_render_resultados_encuesta.element51" /></div>
	</h5>

	<div class="col-xs-12 text-center">
		<!-- Nav tabs -->
		<div class="blockD">
			<h4 class="text-center"><fmt:message key="empresa_render_resultados_encuesta.element52" /></h4>
			<!-- ul class="nav nav-pills super-letra-indicadores centeredD" role="tablist">
		...
		<div class="marco-gris-pane centeredD col-xs-12">
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane active" id="otros26">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element53" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q22_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q22_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q22_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>

				<div role="tabpanel" class="tab-pane active" id="otros27">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element54" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q23_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q23_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q23_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros28">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element55" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q24_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q24_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q24_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros29">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element56" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q25_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q25_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q25_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros30">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element57" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q26_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q26_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q26_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros31">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element58" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q27_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q27_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q27_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros32">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element59" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q28_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q28_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q28_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros33">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element60" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q47_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q47_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q47_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
			</div> <!-- fin de tab-content -->
		</div> <!-- fin de tab panes -->
	...
	<div class="col-xs-12 separador-bottom"  >
		<h4 class="text-center"><fmt:message key="empresa_render_resultados_encuesta.element61" /></h4>
		<div id="gr-otros-5" class="col-md-8 col-centered"></div>
	</div>
</div> <!-- fin capacitacion -->
<div id="otros-salario">
	<h5>
		<div class="label label-primary padding-small"><fmt:message key="empresa_render_resultados_encuesta.element62" /></div>
	</h5>

	<div class="col-xs-12 text-center">
		<!-- Nav tabs -->
		<div class="blockD">
			<h4 class="text-center"><fmt:message key="empresa_render_resultados_encuesta.element63" /></h4>
			<!-- ul class="nav nav-pills super-letra-indicadores centeredD" role="tablist">
		...
		<div class="marco-gris-pane centeredD col-xs-12">
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane active" id="otros34">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element64" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q29_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q29_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q29_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>

				<div role="tabpanel" class="tab-pane active" id="otros35">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element65" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q30_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q30_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q30_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros36">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element66" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q31_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q31_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q31_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros37">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element67" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q32_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q32_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q32_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros38">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element68" /></p>
	...
	<div class="col-xs-12 separador-bottom"  >
		<h4 class="text-center"><fmt:message key="empresa_render_resultados_encuesta.element69" /></h4>
		<div id="gr-otros-6" class="col-md-8 col-centered"></div>
	</div>
</div> <!-- fin salario -->
<div id="otros-prevencion-acoso">
	<h5>
		<div class="label label-primary padding-small"><fmt:message key="empresa_render_resultados_encuesta.element70" /></div>
	</h5>

	<div class="col-xs-12 text-center">
		<!-- Nav tabs -->
		<div class="blockD">
			<h4 class="text-center"><fmt:message key="empresa_render_resultados_encuesta.element71" /></h4>
			<!-- ul class="nav nav-pills super-letra-indicadores centeredD" role="tablist">
		...
		<div class="marco-gris-pane centeredD col-xs-12">
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane active" id="otros39">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element72" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q34_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q34_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q34_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>

				<div role="tabpanel" class="tab-pane active" id="otros40">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element73" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q35_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q35_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q35_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros41">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element74" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q36_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q36_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q36_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros42">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element75" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q37_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q37_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q37_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros43">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element76" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q38_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q38_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q38_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros44">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element77" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q39_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q39_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q39_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros45">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element78" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q40_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q40_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q40_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros46">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element79" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q41_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q41_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q41_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros47">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element80" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q42_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q42_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q42_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros48">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element81" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q48_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q48_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q48_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros49">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element82" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q49_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q49_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q49_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
			</div> <!-- fin de tab-content -->
		</div> <!-- fin de tab panes -->
	...
	<div class="col-xs-12 separador-bottom"  >
		<h4 class="text-center"><fmt:message key="empresa_render_resultados_encuesta.element83" /></h4>
		<div id="gr-otros-7" class="col-md-8 col-centered"></div>
	</div>
</div> <!-- fin acoso -->
<div id="otros-conciliacion">
	<h5>
		<div class="label label-primary padding-small"><fmt:message key="empresa_render_resultados_encuesta.element84" /></div>
	</h5>

	<div class="col-xs-12 text-center">
		<!-- Nav tabs -->
		<div class="blockD">
			<h4 class="text-center"><fmt:message key="empresa_render_resultados_encuesta.element85" /></h4>
			<!-- ul class="nav nav-pills super-letra-indicadores centeredD" role="tablist">
		...
		<div class="marco-gris-pane centeredD col-xs-12">
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane active" id="otros50">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element86" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q50_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q50_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q50_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>

				<div role="tabpanel" class="tab-pane active" id="otros51">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element87" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q51_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q51_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q51_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros52">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element88" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q52_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q52_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q52_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros53">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element89" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q53_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q53_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q53_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros54">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element90" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q54_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q54_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q54_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros55">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element91" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q55_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q55_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q55_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros56">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element92" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q56_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q56_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q56_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros57">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element93" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q57_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q57_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q57_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros58">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element94" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q58_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q58_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q58_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane active" id="otros59">
					<div class="col-xs-12  panel-heading " >
						<p class=" col-xs-12 reset-margin"><fmt:message key="empresa_render_resultados_encuesta.element95" /></p>
						<h4 class=" col-xs-12"><span class="badge"><% if (session.getAttribute("temp_admin_organization_q59_lkup").equals("89")) { %><fmt:message key="empresa_render_resultados_encuesta.element14" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/green_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q59_lkup").equals("90")) { %><fmt:message key="empresa_render_resultados_encuesta.element15" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/yellow_mini.png"><% } else if (session.getAttribute("temp_admin_organization_q59_lkup").equals("91")) { %><fmt:message key="empresa_render_resultados_encuesta.element16" /> <img class="indicador-calificacion" alt="Evaluación positiva o negativa" src="/indica/assets/images/red_mini.png"><% } %></span></h4>
					</div>
				</div>
			</div> <!-- fin de tab-content -->
		</div> <!-- fin de tab panes -->
	...
	<div class="col-xs-12 separador-bottom"  >
		<h4 class="text-center"><fmt:message key="empresa_render_resultados_encuesta.element96" /></h4>
