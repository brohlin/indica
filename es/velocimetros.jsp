			...
			var chart_GE1_ind = new Highcharts.Chart({
					...
					yAxis:{
						...
						series: [{
							...
							dataLabels: {
								 format: '<div style="text-align:center"><span style="font-size:12px;color:black">{y:.2f}%</span><br/><span style="font-size:10px;color:#333;">Valor del indicador</span></div>'
							},
							tooltip: {
								 valueSuffix: '%'
							},
			...
			var chart_GE3_ind = new Highcharts.Chart({
					...
					yAxis:{
						...
						tickPixelInterval: 30, tickWidth: 2, tickPosition: 'inside', tickLength: 10, tickColor: '#fff',
							...
							max: 10,
							labels:{
								formatter:function(){if (this.isLast){return 'Infinito';}
